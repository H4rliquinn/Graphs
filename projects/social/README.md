...
500 times because each call sets up two friendships. So (100*10)/2.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

a> About 99% connected.
b> Average degree of separation is about 5.5.
...
Very, too normalized. I expect real life to be more clustered. Groups all friends with each other but fewer outward extensions.
